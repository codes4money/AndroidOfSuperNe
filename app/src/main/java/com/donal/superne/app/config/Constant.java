...
public class Constant
{
    ...
    //action
    public static final String ACTION_RELEASE   = "com.donal.action.RELEASE";
    public static final String ACTION_RESTART   = "com.donal.action.RESTART";
    public static final String ACTION_CONNECTED = "com.donal.action.CONNECTED";
    public static final String ACTION_LOGIN     = "com.donal.action.LOGIN";
}
